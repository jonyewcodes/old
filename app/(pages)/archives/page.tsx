...
export const metadata = {
  title: "Archives | Singapore Economics League",
};
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {archiveInfo.map((info, index) => (
              ...
              >
                ...
                {/* 
                  NOTE: After results release
                  <a
                    href="/archives/2025/results.pdf"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center justify-center w-full text-secondary font-semibold
                               border-2 border-[#96D0C8] rounded-xl px-4 py-2 hover:bg-[#eaf2fb]
                               shadow-lg transition-transform duration-200 ease-in-out hover:scale-105"
                  >
                    <svg
                ...
                */}
                ...
                {/* NEW IMPLEMENTATION (greyed out & disabled) */}
                <button
                  disabled
