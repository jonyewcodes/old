...
function BriefRules() {
  return (
    <section id="Brief Rules">
      ...
      <p className="mt-4">
        <span className="font-semibold">What is it:</span> SEL is a <b>4-hour long</b>, team online
      ...
      <p className="mt-4">
        ...
        exclusively to students in<b> pre-university education</b>, i.e. Junior Colleges, Secondary
      ...
      <p className="mt-4">
        ...
        <b>strictly prohibited</b>. The usage of <b>any</b> Generative AI tools such as ChatGPT is
        also <b>strictly prohibited</b>.
      </p>
      <p className="mt-4">
      ...
      <div className="bg-white border-2 border-primary rounded shadow overflow-hidden">
        ...
        <div className={`overflow-hidden transition-all duration-300 ${isOpen ? "max-h-[300px]" : "max-h-0"}`}>
          <ul className="flex flex-col space-y-2 p-4">
            {sectionIds.map((id) => (
              <li key={id}>
                <button onClick={() => handleScrollTo(id)} className="text-primary font-semibold text-left w-full slab">
                  {id}
                </button>
              </li>
            ))}
      ...
      <div className="flex justify-center mb-10">
        <div className="max-w-screen-lg w-full flex flex-col lg:flex-row px-4 md:px-0">
          ...
          <div id="main-content" className="w-full lg:pl-16 mt-16">
            ...
            <TermsAndConditions />
            <p className="text-sm text-gray-500 mt-8">Last Updated: 1 March 2025</p>
          </div>
        </div>
      </div>
    </>
