    ...
    <main className="min-h-screen w-full flex flex-col items-center">
      ...
      ">
        ...
        <ul className="list-disc ml-5 mb-6 space-y-2 leading-relaxed">
          <li>
            <strong>Contact Information:</strong> Full name, email address, phone number, and mailing address.
          </li>
          <li>
            <strong>Demographic Details:</strong> Age, gender, and school affiliation.
          </li>
          <li>
        ...
        <ul className="list-disc ml-5 mb-6 space-y-2 leading-relaxed">
          <li>
            <strong>Team Information:</strong> Team names, member details, and associated credentials.
          </li>
          <li>
            <strong>Submission Data:</strong> Answers, scores, and performance metrics from contest entries.
          </li>
          <li>
        ...
        <ul className="list-disc ml-5 mb-6 space-y-2 leading-relaxed">
          <li>
            <strong>Cookies and Tracking Technologies:</strong> To analyze browsing behavior and usage patterns.
          </li>
          <li>
        ...
        <ul className="list-disc ml-5 mb-6 space-y-2 leading-relaxed">
          <li>
            <strong>Manage Registrations:</strong> Process and verify competition entries and team details.
          </li>
          <li>
            <strong>Communicate Effectively:</strong> Send important updates regarding competition schedules, platform access details, and support notifications.
          </li>
          <li>
        ...
        <ul className="list-disc ml-5 mb-6 space-y-2 leading-relaxed">
          <li>
            <strong>Meet Legal Requirements:</strong> Comply with local laws, regulatory guidelines, and PDPA provisions.
          </li>
          <li>
        ...
        <ul className="list-disc ml-5 mb-6 space-y-2 leading-relaxed">
          <li>
            <strong>Refine Competition Formats:</strong> Develop, test, and improve our contest formats and digital platforms.
          </li>
          <li>
        ...
        <ul className="list-disc ml-5 mb-6 space-y-2 leading-relaxed">
          <li>
            <strong>Send Newsletters and Updates:</strong> Inform you about upcoming competitions, news, and events.
          </li>
          <li>
        ...
        <ul className="list-disc ml-5 mb-6 space-y-2 leading-relaxed">
          ...
          <li>
            <strong>Email and SMS Communications</strong>
          </li>
          <li>
        ...
        <ul className="list-disc ml-5 mb-6 space-y-2 leading-relaxed">
          <li>
            <strong>For Legal Compliance:</strong> To comply with legal obligations or respond to lawful requests by public authorities.
          </li>
          <li>
        ...
        <ul className="list-disc ml-5 mb-6 space-y-2 leading-relaxed">
          <li>
            <strong>Fulfill the Purposes:</strong> For which it was collected, including registration, competition administration, and legal compliance.
          </li>
          <li>
            <strong>Legal Requirements:</strong> Comply with applicable laws and regulations.
          </li>
        </ul>
        <p className="mb-6 leading-relaxed">
        ...
        <ul className="list-disc ml-5 mb-6 space-y-2 leading-relaxed">
          <li>
            <strong>Encryption:</strong> Using industry-standard encryption methods for data in transit and at rest.
          </li>
          <li>
            <strong>Access Controls:</strong> Restricting access to your data to authorized personnel only.
          </li>
          <li>
            <strong>Regular Audits:</strong> Conducting periodic reviews of our security practices to identify and mitigate potential risks.
          </li>
        </ul>
        <p className="mb-6 leading-relaxed">
        ...
        <ul className="list-disc ml-5 mb-6 space-y-2 leading-relaxed">
          <li>
            <strong>Improve Functionality:</strong> Enhance navigation and user experience.
          </li>
          <li>
            <strong>Collect Analytics:</strong> Understand how visitors interact with our website.
          </li>
        </ul>
        <p className="mb-6 leading-relaxed">
        ...
        <ul className="list-disc ml-5 mb-6 space-y-2 leading-relaxed">
          ...
          <li>
            <strong>Warranty Disclaimer:</strong> The information provided on this website is for general informational purposes only. SEL disclaims all warranties regarding accuracy, completeness, and reliability.
          </li>
          <li>
